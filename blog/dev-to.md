---
title: I Wrote a Claude Skill That Sets Up Loop Engineering in Your Repo
published: false
description: I built a Claude Code skill that sets up an autonomous engineering loop in your repo with one command. Here is what loop engineering is, what the skill scaffolds, and how to use it.
tags: ai, agents, automation, programming
---
